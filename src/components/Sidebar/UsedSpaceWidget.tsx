  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="h-2 rounded-full bg-violet-100 dark:bg-zinc-600">
        <div className="h-2 w-3/4 rounded-full bg-violet-600 dark:bg-violet-400"></div>
      </div>

      <div className="space-x-3">
        <button className="text-sm font-medium text-violet-500 hover:text-violet-700 dark:text-violet-300 dark:hover:text-violet-200">
          Ignorar
        </button>
        <button className="text-sm font-medium text-violet-700 hover:text-violet-900 dark:text-zinc-300 dark:hover:text-zinc-100">
          Atualizar plano
        </button>
      </div>
    </div>
