...
export default function Home() {
  return (
    <>
      <h1 className="to-zinc-900 text-3xl font-medium">Configurações</h1>
        ...
        >
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                id="bio"
                defaultValue="Sou um Designer de Produtos morando em Melbourne, Austrália. Especialista em UX."
              />
            </div>
          </div>
